        ...
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
          <div class="px-6 py-4 flex flex-col gap-4">
            ...
            <div class="w-full">
              ...
              <select class="form-select rounded-md w-full" name="category_id" id="category_id" required>
          ...
          <div class="px-6 py-4 flex gap-4 justify-end">
          <x-button class="disabled:opacity-25 w-32" id="guardar">
                <span>
                    Guardar
  ...
  <script>
    ...
    boton.addEventListener('click', function() {
      ...
      if(localStorage.getItem("geojson")) {
        //console.log(JSON.parse(localStorage.getItem("geojson")));
        if(name && category_id) {
          axios.post('/mapas', {
            name: name,
